...
export default function Home() {
  ...
  // Logic untuk ganti class di elemen HTML
  useEffect(() => {
    if (darkMode) {
        ...
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600 dark:text-slate-400">
            ...
            <button
              ...
              className="cursor-pointer p-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800 transition"
              aria-label="Toggle theme"
            >
              {darkMode ? (
                <svg
                  className="w-5 h-5 hover:text-yellow-400 transition-colors duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  className="w-5 h-5 hover:text-blue-400 transition-colors duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          >
            ...
            <button
              onClick={() => setDarkMode(!darkMode)}
              className="flex items-center gap-3 p-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition"
              aria-label="Toggle theme"
            >
              {darkMode ? (
                <>
